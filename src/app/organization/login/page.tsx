...
/**
 * @feature ORGANIZATION_LOGIN_PORTAL
 * @aiNote Dedicated login portal for organizations matching Engineer Portal design.
 * Has purple/indigo branding. Routes based on role after login.
 */
export default function OrganizationLoginPage() {
    ...
    // Note: Registration check removed because RLS policies may prevent
    // client-side queries to users table. Auth will handle validation during login.
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // In Organization Portal, we always want to go to /organization/dashboard
            // Unless the user is clearly an engineer (provider) who lost their way
            if (role === "provider") {
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-800 to-indigo-900 flex items-center justify-center p-6">
            <div className="w-full max-w-sm">
                ...
                <div className="flex flex-col items-center mb-12">
                    ...
                    <h1 className="font-bold text-2xl text-white tracking-tighter">Organization Portal</h1>
                    <p className="text-indigo-300 text-sm mt-2">Find placement opportunities, manage your profile, and connect with recruiters.</p>
                </div>
                ...
                <div className="mt-8 text-center space-y-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link
                            href="/login"
                            className="text-indigo-400/60 text-sm hover:text-indigo-300 transition-colors"
                        >
                            ← Back to Main Portal
                        </Link>
                    </div>
